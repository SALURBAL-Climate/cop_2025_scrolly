...
<section>
  <div class="wrapper">
    ...
    <p>
      This library contains a series of components for building Mapbox GL JS v1
      maps within Svelte apps. They are primarily built with data visualisation
      use cases in mind, and generally assume the use of self-hosted map tiles
      and/or geojson sources.
    </p>
    <p>
      Below are a series of examples of how to use the components to display
      maps. View the source code of the <a
        href="https://github.com/ONSvisual/svelte-maps/blob/main/src/App.svelte"
        >App.svelte</a
      > file in this repository to see how they are used.
    </p>
  </div>
</section>
...
<section>
  <div class="grid">
    <div>
      ...
      (zoom: {zoom ? zoom.toFixed(1) : ''}, lon: {center.lng
    ...
    <div>
      ...
      (hovered: {hovered ? hovered : ''}, selected: {#if selected}
        {selected}
        <button on:click|preventDefault={() => (selected = null)}>x</button
        >{/if})
    </div>
    <div>
      <div class="map">
